...
function displayPopUp(score) {
    ...
    if (score < 1) {
        ...
        title.textContent = "1 Star score 6 or above for the next star";
        ...
        title.textContent = "2 Stars score 11 or above for the next star";
    ...
    login.textContent = "log as new highscore";
    login.onclick = function() {
        window.location.href = "login.html"; // Redirect to level 2 page
    };
...
localStorage.setItem(score); // Store the score in localStora
